# Contributing to Angular Firedash Starter
...
we use the git commit messages to **generate the [change log](https://github.com/max-geller/angular-firedash/CHANGELOG.md)**.
